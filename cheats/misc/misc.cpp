...
#if RELEASE
#if BETA
#define VERSION crypt_str("ch4zhook | ")
#else
#define VERSION crypt_str("ch4zhook | ")
#endif
#else
...
void misc::ChatSpamer()
{
	...
	{ 
		crypt_str("ch4zhook - stay with us or lose the game."),
		crypt_str("Get good. Get ch4zhook."),
		crypt_str("ch4zhook - just the best."),
		crypt_str("Go to another level with ch4zhook."),
	};
